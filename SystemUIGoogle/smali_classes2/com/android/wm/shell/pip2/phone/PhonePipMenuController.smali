...
.field public mMediaActionListener:Lcom/android/wm/shell/pip2/phone/PhonePipMenuController$1;
...
.method public final attach(Landroid/view/SurfaceControl;)V
    ...
    .line 4
    .line 5
    iget-object p1, p0, Lcom/android/wm/shell/pip2/phone/PhonePipMenuController;->mPipDisplayLayoutState:Lcom/android/wm/shell/common/pip/PipDisplayLayoutState;
    ...
    .line 25
    .line 26
    iput-object v2, p0, Lcom/android/wm/shell/pip2/phone/PhonePipMenuController;->mPipMenuView:Lcom/android/wm/shell/pip2/phone/PipMenuView;

    .line 27
    .line 28
    :cond_1
    :goto_0
    iget-object v4, p1, Lcom/android/wm/shell/common/pip/PipDisplayLayoutState;->mUiContext:Landroid/content/Context;

    .line 29
    .line 30
    new-instance v3, Lcom/android/wm/shell/pip2/phone/PipMenuView;

    .line 31
    .line 32
    iget-object v6, p0, Lcom/android/wm/shell/pip2/phone/PhonePipMenuController;->mMainExecutor:Lcom/android/wm/shell/common/ShellExecutor;

    .line 33
    .line 34
    iget-object v7, p0, Lcom/android/wm/shell/pip2/phone/PhonePipMenuController;->mMainHandler:Landroid/os/Handler;

    .line 35
    .line 36
    iget-object v8, p0, Lcom/android/wm/shell/pip2/phone/PhonePipMenuController;->mPipUiEventLogger:Lcom/android/wm/shell/common/pip/PipUiEventLogger;
    ...
    .line 39
    invoke-direct/range {v3 .. v8}, Lcom/android/wm/shell/pip2/phone/PipMenuView;-><init>(Landroid/content/Context;Lcom/android/wm/shell/pip2/phone/PhonePipMenuController;Lcom/android/wm/shell/common/ShellExecutor;Landroid/os/Handler;Lcom/android/wm/shell/common/pip/PipUiEventLogger;)V

    .line 40
    .line 41
    .line 42
    iput-object v3, v5, Lcom/android/wm/shell/pip2/phone/PhonePipMenuController;->mPipMenuView:Lcom/android/wm/shell/pip2/phone/PipMenuView;

    .line 43
    .line 44
    new-instance p0, Lcom/android/wm/shell/pip2/phone/PhonePipMenuController$4;
    ...
    .line 48
    .line 49
    iput-object v5, p0, Lcom/android/wm/shell/pip2/phone/PhonePipMenuController$4;->this$0:Lcom/android/wm/shell/pip2/phone/PhonePipMenuController;
    ...
    .line 56
    .line 57
    iget-object p0, v5, Lcom/android/wm/shell/pip2/phone/PhonePipMenuController;->mPipMenuView:Lcom/android/wm/shell/pip2/phone/PipMenuView;
    ...
    .line 60
    invoke-static {v1, v1, v4}, Lcom/android/wm/shell/common/pip/PipMenuController;->getPipMenuLayoutParams(IILandroid/content/Context;)Landroid/view/WindowManager$LayoutParams;
    ...
    .line 65
    .line 66
    invoke-virtual {v0, p0, v1, p1}, Lcom/android/wm/shell/common/SystemWindows;->addView(Landroid/view/View;Landroid/view/WindowManager$LayoutParams;I)V

    .line 67
    .line 68
    .line 69
    iget p0, v5, Lcom/android/wm/shell/pip2/phone/PhonePipMenuController;->mMenuState:I
    ...
    .line 82
    :goto_1
    invoke-virtual {v5}, Lcom/android/wm/shell/pip2/phone/PhonePipMenuController;->updateMenuActions()V
...
.method public final hideMenu(I)V
    ...
    .line 7
    invoke-virtual {p0, v0, v1, v2, p1}, Lcom/android/wm/shell/pip2/phone/PipMenuView;->hideMenu(Lcom/android/wm/shell/pip2/phone/PipMenuView$$ExternalSyntheticLambda0;ZZI)V
...
.method public final movePipMenu(Landroid/graphics/Rect;Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;)V
    ...
    .line 8
    :cond_0
    invoke-virtual {p0}, Lcom/android/wm/shell/pip2/phone/PhonePipMenuController;->checkPipMenuState()Z
...
.method public final onPipTransitionStateChanged(IILandroid/os/Bundle;)V
    ...
    .line 18
    :cond_0
    invoke-virtual {p0}, Lcom/android/wm/shell/pip2/phone/PhonePipMenuController;->detach()V
    ...
    .line 34
    :cond_4
    iget-object p1, p0, Lcom/android/wm/shell/pip2/phone/PhonePipMenuController;->mPipTransitionState:Lcom/android/wm/shell/pip2/phone/PipTransitionState;

    .line 35
    .line 36
    iget-object p1, p1, Lcom/android/wm/shell/pip2/phone/PipTransitionState;->mPinnedTaskLeash:Landroid/view/SurfaceControl;

    .line 37
    .line 38
    invoke-virtual {p0, p1}, Lcom/android/wm/shell/pip2/phone/PhonePipMenuController;->attach(Landroid/view/SurfaceControl;)V
...
.method public final showMenuInternal(ILandroid/graphics/Rect;ZZZ)V
    ...
    .line 10
    .line 11
    invoke-virtual {v0}, Lcom/android/wm/shell/pip2/phone/PhonePipMenuController;->checkPipMenuState()Z
    ...
    .line 20
    invoke-virtual {v0, v2, v5, v5}, Lcom/android/wm/shell/pip2/phone/PhonePipMenuController;->movePipMenu(Landroid/graphics/Rect;Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;)V
    ...
    .line 48
    iput-boolean v6, v0, Lcom/android/wm/shell/pip2/phone/PipMenuView;->mAllowTouches:Z

    .line 49
    .line 50
    iget-object v6, v0, Lcom/android/wm/shell/pip2/phone/PipMenuView;->mMainExecutor:Lcom/android/wm/shell/common/ShellExecutor;

    .line 51
    .line 52
    iget-object v9, v0, Lcom/android/wm/shell/pip2/phone/PipMenuView;->mHideMenuRunnable:Lcom/android/wm/shell/pip2/phone/PipMenuView$$ExternalSyntheticLambda0;
    ...
    .line 58
    .line 59
    iget-object v6, v0, Lcom/android/wm/shell/pip2/phone/PipMenuView;->mMenuContainerAnimator:Landroid/animation/AnimatorSet;
    ...
    .line 70
    .line 71
    iput-object v6, v0, Lcom/android/wm/shell/pip2/phone/PipMenuView;->mMenuContainerAnimator:Landroid/animation/AnimatorSet;

    .line 72
    .line 73
    iget-object v6, v0, Lcom/android/wm/shell/pip2/phone/PipMenuView;->mMenuContainer:Landroid/view/View;
    ...
    .line 94
    iget-object v12, v0, Lcom/android/wm/shell/pip2/phone/PipMenuView;->mMenuBgUpdateListener:Lcom/android/wm/shell/pip2/phone/PipMenuView$1;
    ...
    .line 132
    .line 133
    iget-object v10, v0, Lcom/android/wm/shell/pip2/phone/PipMenuView;->mMenuContainerAnimator:Landroid/animation/AnimatorSet;
    ...
    .line 174
    .line 175
    invoke-direct {v3, v8}, Lcom/android/wm/shell/pip2/phone/PipMenuView$$ExternalSyntheticLambda0;-><init>(I)V

    .line 176
    .line 177
    .line 178
    iput-object v0, v3, Lcom/android/wm/shell/pip2/phone/PipMenuView$$ExternalSyntheticLambda0;->f$0:Ljava/lang/Object;
    ...
    .line 187
    :cond_5
    invoke-virtual {v0, v1, v4, v5}, Lcom/android/wm/shell/pip2/phone/PipMenuView;->notifyMenuStateChangeStart(IZLcom/android/wm/shell/pip2/phone/PipMenuView$$ExternalSyntheticLambda0;)V
...
.method public final updateMenuActions()V
    ...
    .line 11
    sget-object v2, Lcom/android/wm/shell/shared/pip/PipFlags;->isPipUmoExperienceEnabled$delegate:Lkotlin/Lazy;
    ...
    .line 24
    .line 25
    iget-object v2, p0, Lcom/android/wm/shell/pip2/phone/PhonePipMenuController;->mMediaController:Lcom/android/wm/shell/common/pip/PipMediaController;

    .line 26
    .line 27
    iget-object v2, v2, Lcom/android/wm/shell/common/pip/PipMediaController;->mMediaController:Landroid/media/session/MediaController;
    ...
    .line 30
    .line 31
    iget-object v2, p0, Lcom/android/wm/shell/pip2/phone/PhonePipMenuController;->mMediaActions:Ljava/util/List;
    ...
    .line 34
    :cond_0
    iget-object v2, p0, Lcom/android/wm/shell/pip2/phone/PhonePipMenuController;->mAppActions:Ljava/util/List;
    ...
    .line 50
    .line 51
    iget-object v3, v0, Lcom/android/wm/shell/pip2/phone/PipMenuView;->mActions:Ljava/util/List;
...
.method public final updateMenuBounds(Landroid/graphics/Rect;)V
    ...
    .line 4
    .line 5
    iget-object p0, p0, Lcom/android/wm/shell/pip2/phone/PhonePipMenuController;->mContext:Landroid/content/Context;
    ...
    .line 15
    invoke-static {v2, p1, p0}, Lcom/android/wm/shell/common/pip/PipMenuController;->getPipMenuLayoutParams(IILandroid/content/Context;)Landroid/view/WindowManager$LayoutParams;
    ...
    .line 19
    iget-object p1, v0, Lcom/android/wm/shell/common/SystemWindows;->mViewRoots:Ljava/util/HashMap;
