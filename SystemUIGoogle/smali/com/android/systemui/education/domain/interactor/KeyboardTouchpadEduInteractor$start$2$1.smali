.class public final Lcom/android/systemui/education/domain/interactor/KeyboardTouchpadEduInteractor$start$2$1;
...
.method public final emit(Lcom/android/systemui/inputdevice/data/model/UserDeviceConnectionStatus;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget-object v0, p0, Lcom/android/systemui/education/domain/interactor/KeyboardTouchpadEduInteractor$start$2$1;->this$0:Lcom/android/systemui/education/domain/interactor/KeyboardTouchpadEduInteractor;

    instance-of v1, p2, Lcom/android/systemui/education/domain/interactor/KeyboardTouchpadEduInteractor$start$2$1$emit$1;

    if-eqz v1, :cond_0

    move-object v1, p2

    check-cast v1, Lcom/android/systemui/education/domain/interactor/KeyboardTouchpadEduInteractor$start$2$1$emit$1;

    iget v2, v1, Lcom/android/systemui/education/domain/interactor/KeyboardTouchpadEduInteractor$start$2$1$emit$1;->label:I
    ...
    iput v2, v1, Lcom/android/systemui/education/domain/interactor/KeyboardTouchpadEduInteractor$start$2$1$emit$1;->label:I

    goto :goto_0

    :cond_0
    new-instance v1, Lcom/android/systemui/education/domain/interactor/KeyboardTouchpadEduInteractor$start$2$1$emit$1;

    invoke-direct {v1, p0, p2}, Lcom/android/systemui/education/domain/interactor/KeyboardTouchpadEduInteractor$start$2$1$emit$1;-><init>(Lcom/android/systemui/education/domain/interactor/KeyboardTouchpadEduInteractor$start$2$1;Lkotlin/coroutines/Continuation;)V

    :goto_0
    iget-object p0, v1, Lcom/android/systemui/education/domain/interactor/KeyboardTouchpadEduInteractor$start$2$1$emit$1;->result:Ljava/lang/Object;
    ...
    iget-object p1, v1, Lcom/android/systemui/education/domain/interactor/KeyboardTouchpadEduInteractor$start$2$1$emit$1;->L$0:Ljava/lang/Object;
    ...
    .line 4
    iput-object v3, v1, Lcom/android/systemui/education/domain/interactor/KeyboardTouchpadEduInteractor$start$2$1$emit$1;->L$0:Ljava/lang/Object;

    iput v5, v1, Lcom/android/systemui/education/domain/interactor/KeyboardTouchpadEduInteractor$start$2$1$emit$1;->label:I
    ...
    .line 13
    iget-object p0, p0, Lcom/android/systemui/education/data/model/EduDeviceConnectionTime;->touchpadFirstConnectionTime:Ljava/time/Instant;
    ...
    iput v4, v1, Lcom/android/systemui/education/domain/interactor/KeyboardTouchpadEduInteractor$start$2$1$emit$1;->label:I
    ...
    invoke-direct {v0, v2}, Lcom/android/systemui/education/domain/interactor/ContextualEducationInteractor$$ExternalSyntheticLambda0;-><init>(I)V
...
.method public final bridge synthetic emit(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/systemui/education/domain/interactor/KeyboardTouchpadEduInteractor$start$2$1;->emit(Lcom/android/systemui/inputdevice/data/model/UserDeviceConnectionStatus;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
