...
.method public static broadcastFlow$default(Lcom/android/systemui/broadcast/BroadcastDispatcher;Landroid/content/IntentFilter;Landroid/os/UserHandle;I)Lkotlinx/coroutines/flow/Flow;
    .locals 10
    ...
    .line 4
    new-instance v8, Lcom/android/systemui/broadcast/BroadcastDispatcher$$ExternalSyntheticLambda0;

    invoke-direct {v8}, Ljava/lang/Object;-><init>()V

    .line 5
    new-instance v2, Lcom/android/systemui/broadcast/BroadcastDispatcher$broadcastFlow$1;
...
.method public final broadcastFlow(Landroid/content/IntentFilter;Landroid/os/UserHandle;ILjava/lang/String;)Lkotlinx/coroutines/flow/Flow;
    ...
    .line 1
    new-instance v6, Lcom/android/systemui/broadcast/BroadcastDispatcher$$ExternalSyntheticLambda0;
...
.method public createUBRForUser(I)Lcom/android/systemui/broadcast/UserBroadcastDispatcher;
    ...
    .line 1
    new-instance v0, Lcom/android/systemui/broadcast/UserBroadcastDispatcher;
    ...
    .line 4
    .line 5
    iget-object v2, p0, Lcom/android/systemui/broadcast/BroadcastDispatcher;->broadcastLooper:Landroid/os/Looper;

    .line 6
    .line 7
    iget-object v3, p0, Lcom/android/systemui/broadcast/BroadcastDispatcher;->broadcastExecutor:Ljava/util/concurrent/Executor;
    ...
    .line 11
    .line 12
    iput-object v1, v0, Lcom/android/systemui/broadcast/UserBroadcastDispatcher;->context:Landroid/content/Context;

    .line 13
    .line 14
    iput p1, v0, Lcom/android/systemui/broadcast/UserBroadcastDispatcher;->userId:I

    .line 15
    .line 16
    iput-object v2, v0, Lcom/android/systemui/broadcast/UserBroadcastDispatcher;->workerLooper:Landroid/os/Looper;

    .line 17
    .line 18
    iput-object v3, v0, Lcom/android/systemui/broadcast/UserBroadcastDispatcher;->workerExecutor:Ljava/util/concurrent/Executor;

    .line 19
    .line 20
    iget-object p1, p0, Lcom/android/systemui/broadcast/BroadcastDispatcher;->logger:Lcom/android/systemui/broadcast/logging/BroadcastDispatcherLogger;

    .line 21
    .line 22
    iput-object p1, v0, Lcom/android/systemui/broadcast/UserBroadcastDispatcher;->logger:Lcom/android/systemui/broadcast/logging/BroadcastDispatcherLogger;
    ...
    .line 25
    .line 26
    iput-object p0, v0, Lcom/android/systemui/broadcast/UserBroadcastDispatcher;->removalPendingStore:Lcom/android/systemui/broadcast/PendingRemovalStore;
    ...
    .line 32
    .line 33
    iput-object p0, v0, Lcom/android/systemui/broadcast/UserBroadcastDispatcher;->workerHandler:Landroid/os/Handler;
    ...
    .line 39
    .line 40
    iput-object p0, v0, Lcom/android/systemui/broadcast/UserBroadcastDispatcher;->actionsToActionsReceivers:Landroid/util/ArrayMap;
    ...
    .line 46
    .line 47
    iput-object p0, v0, Lcom/android/systemui/broadcast/UserBroadcastDispatcher;->receiverToActions:Landroid/util/ArrayMap;
...
.method public final registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/util/concurrent/Executor;Landroid/os/UserHandle;ILjava/lang/String;)V
    ...
    .line 15
    iput-object p1, v0, Lcom/android/systemui/broadcast/ReceiverData;->receiver:Landroid/content/BroadcastReceiver;

    .line 16
    iput-object p2, v0, Lcom/android/systemui/broadcast/ReceiverData;->filter:Landroid/content/IntentFilter;

    .line 17
    iput-object p3, v0, Lcom/android/systemui/broadcast/ReceiverData;->executor:Ljava/util/concurrent/Executor;

    .line 18
    iput-object p4, v0, Lcom/android/systemui/broadcast/ReceiverData;->user:Landroid/os/UserHandle;

    .line 19
    iput-object p6, v0, Lcom/android/systemui/broadcast/ReceiverData;->permission:Ljava/lang/String;
